...
public class UserCommandDispatcher implements CommandDispatcher {
    ...
    public void send(BaseCommand command) {
        ...
        if(handlers == null || handlers.size() == 0) {
            throw new RuntimeException("No registered command handler");
        }
        if(handlers.size() > 1) {
